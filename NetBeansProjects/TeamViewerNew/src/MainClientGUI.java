...
public class MainClientGUI extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jButton2.setBounds(470, 20, 60, 50);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Backgnd.PNG"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(440, 0, 120, 580);

        jt1.setText("jTextField1");
        getContentPane().add(jt1);
        jt1.setBounds(240, 30, 160, 30);
